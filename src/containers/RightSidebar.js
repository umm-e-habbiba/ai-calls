...
import CreateAssistant from "../features/common/components/CreateAssistant";
  ...
  return (
    ...
    >
      <section
        className={
          `w-80 ${
            bodyType == "CREATE_ASSISTANT" ? "md:w-2/4" : "md:w-96"
      ...
      >
        <div className="relative  pb-5 flex flex-col  h-full">
          {/* Header */}
          <div className="navbar flex justify-between items-center pl-4 pr-4 shadow-md ">
            <span className="mr-2 font-bold text-xl">{header}</span>
            <button
              ...
              {
                {
                  ...
                  [RIGHT_DRAWER_TYPES.CREATE_ASSISTANT]: (
                    <CreateAssistant
                      {...extraObject}
                      closeRightDrawer={close}
                    />
